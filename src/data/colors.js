...
//
// Category order: for now (2026-08-14), sorted by total color count,
// descending, so the biggest/most-common categories are never buried below
// the fold — this overrides the older color-wheel ordering documented
// elsewhere in this file's history. Re-run the count whenever colors are
// added/removed/recategorized: for each category, sum colors.length across
// every collection, then sort descending. The color-wheel/neutral-bucket
// grouping logic (hue families → Nudes/Classics/Grays → Thermal/Shimmer)
// still governs which category a *color* belongs to — it's just not what
// orders the array anymore.
...
export const categories = [
  {
    ...
    collections: [
      ...
      },
      {
        ...
        name: "DND",
        colors: [
          { id: "dnd-051", name: "Light Macore", number: "051", image: "/images/colors/nudes/dnd-light_macore-051.jpg", swatchHex: "#482C26" },
          { id: "dnd-041", name: "Light Mahogany", number: "041", image: "/images/colors/nudes/dnd-light_mahogany-041.jpg", swatchHex: "#6D4C4A" },
          { id: "dnd-038", name: "Mahogany", number: "038", image: "/images/colors/nudes/dnd-mahogany-038.jpg", swatchHex: "#995C58" },
          { id: "dnd-042", name: "Red Cherry", number: "042", image: "/images/colors/nudes/dnd-red_cherry-042.jpg", swatchHex: "#6E4947" },
          { id: "dnd-040", name: "Sandy Brown", number: "040", image: "/images/colors/nudes/dnd-sandy_brown-040.jpg", swatchHex: "#705753" },
          { id: "dnd-053", name: "Spiced Brown", number: "053", image: "/images/colors/nudes/dnd-spiced_brown-053.jpg", swatchHex: "#2A211C" },
        ],
      },
      {
  ...
  },
  {
    ...
    collections: [
      ...
      },
      {
        ...
        name: "DND",
        colors: [
          { id: "dnd-058", name: "Aqua Pink", number: "058", image: "/images/colors/pinks/dnd-aqua_pink-058.jpg", swatchHex: "#BD9694" },
          { id: "dnd-059", name: "Sheer Pink", number: "059", image: "/images/colors/pinks/dnd-sheer_pink-059.jpg", swatchHex: "#CF9A9D" },
          { id: "dnd-037", name: "Terr Pink", number: "037", image: "/images/colors/pinks/dnd-terr_pink-037.jpg", swatchHex: "#BE6F66" },
          { id: "dnd-039", name: "Fire Brick", number: "039", image: "/images/colors/pinks/dnd-fire_brick-039.jpg", swatchHex: "#8C504C" },
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    collections: [
      ...
      },
      {
        ...
        name: "DND",
        colors: [
          { id: "dnd-049", name: "Dazzle Zone", number: "049", image: "/images/colors/berries/dnd-dazzle_zone-049.jpg", swatchHex: "#4E2931" },
          { id: "dnd-048", name: "Electric Purple", number: "048", image: "/images/colors/berries/dnd-electric_purple-048.jpg", swatchHex: "#39313A" },
          { id: "dnd-047", name: "Smokey Yard", number: "047", image: "/images/colors/berries/dnd-smokey_yard-047.jpg", swatchHex: "#392F2F" },
          { id: "dnd-062", name: "Strawberry Wine", number: "062", image: "/images/colors/berries/dnd-strawberry_wine-062.jpg", swatchHex: "#4C3936" },
          { id: "dnd-050", name: "Twilight Sparkles", number: "050", image: "/images/colors/berries/dnd-twilight_sparkles-050.jpg", swatchHex: "#3C1E27" },
          { id: "dnd-061", name: "Wineberry", number: "061", image: "/images/colors/berries/dnd-wineberry-061.jpg", swatchHex: "#503A38" },
        ],
      },
      {
    ...
    collections: [
      {
        ...
        name: "DND",
        colors: [
          { id: "dnd-071", name: "Cherry Pink", number: "071", image: "/images/colors/reds/dnd-cherry_pink-071.jpg", swatchHex: "#6D2927" },
          { id: "dnd-072", name: "Crimson", number: "072", image: "/images/colors/reds/dnd-crimson-072.jpg", swatchHex: "#6E2426" },
          { id: "dnd-067", name: "Fire Engine Red", number: "067", image: "/images/colors/reds/dnd-fire_engine_red-067.jpg", swatchHex: "#95372E" },
          { id: "dnd-066", name: "French Raspberry", number: "066", image: "/images/colors/reds/dnd-french_raspberry-066.jpg", swatchHex: "#973931" },
          { id: "dnd-068", name: "Lava Red", number: "068", image: "/images/colors/reds/dnd-lava_red-068.jpg", swatchHex: "#8F332D" },
          { id: "dnd-065", name: "Thai Chili Red", number: "065", image: "/images/colors/reds/dnd-thai_chili_red-065.jpg", swatchHex: "#B7473F" },
          { id: "dnd-064", name: "Valentine Red", number: "064", image: "/images/colors/reds/dnd-valentine_red-064.jpg", swatchHex: "#BA4A3A" },
          { id: "dnd-069", name: "Royal Pink", number: "069", image: "/images/colors/reds/dnd-royal_pink-069.jpg", swatchHex: "#8A302D" },
          { id: "dnd-070", name: "Visionary Pink", number: "070", image: "/images/colors/reds/dnd-visionary_pink-070.jpg", swatchHex: "#86302E" },
        ],
      },
      {
        id: "chance-by-cre8tion-hello-autumn",
  ...
  },
  {
    ...
    collections: [
      ...
      },
      {
        ...
        name: "DND",
        colors: [
          { id: "dnd-063", name: "Shocking Orange", number: "063", image: "/images/colors/corals/dnd-shocking_orange-063.jpg", swatchHex: "#D35245" },
        ],
      },
      {
        id: "dnd-sheer-collection-2023",
  ...
  },
  {
    ...
    collections: [
      ...
      },
      {
        ...
        name: "DND",
        colors: [
          { id: "dnd-057", name: "White Bunny", number: "057", image: "/images/colors/classics/dnd-white_bunny-057.jpg", swatchHex: "#CDCABB" },
          { id: "dnd-056", name: "White Chalk", number: "056", image: "/images/colors/classics/dnd-white_chalk-056.jpg", swatchHex: "#D3D3C6" },
        ],
      },
    ],
  },
    ...
    collections: [
      {
        ...
        name: "DND",
        colors: [
          { id: "dnd-060", name: "Beet Root", number: "060", image: "/images/colors/grays/dnd-beet_root-060.jpg", swatchHex: "#423C3C" },
          { id: "dnd-044", name: "London Bridge", number: "044", image: "/images/colors/grays/dnd-london_bridge-044.jpg", swatchHex: "#50494B" },
          { id: "dnd-045", name: "Pepperwood", number: "045", image: "/images/colors/grays/dnd-pepperwood-045.jpg", swatchHex: "#574C4B" },
          { id: "dnd-043", name: "Dark Salmon", number: "043", image: "/images/colors/grays/dnd-dark_salmon-043.jpg", swatchHex: "#54535F" },
          { id: "dnd-046", name: "Pewter Gray", number: "046", image: "/images/colors/grays/dnd-pewter_gray-046.jpg", swatchHex: "#3E3333" },
          { id: "dnd-055", name: "Black Chalk", number: "055", image: "/images/colors/grays/dnd-black_chalk-055.jpg", swatchHex: "#46473F" },
          { id: "dnd-054", name: "Mud Oak", number: "054", image: "/images/colors/grays/dnd-mud_oak-054.jpg", swatchHex: "#1C1A1A" },
        ],
      },
    ],
  },
